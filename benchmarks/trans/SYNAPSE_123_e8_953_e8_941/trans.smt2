...
(define-fun .def_917 () Bool (and param_e_s1.next param_e_s2.next))
(define-fun .def_918 () Bool (and param_e_s1.next .def_917))
(define-fun .def_919 () Bool (and param_e_s3.next .def_918))
(define-fun .def_920 () Bool (and param_e_s2.next .def_919))
(define-fun .def_921 () Bool (and param_e_s3.next .def_920))
