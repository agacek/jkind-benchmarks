...
(define-fun .def_866 () Bool (<= 0 param_i_invalid))
(define-fun .def_868 () Bool (and .def_866 call_excludes8.excludes))
(define-fun .def_870 () Bool (= .def_868 call_Sofar.flby))
(define-fun .def_864 () Bool (= call_firefly.flby5 0))
(define-fun .def_861 () Bool (= call_firefly.flby4 0))
(define-fun .def_858 () Bool (= call_firefly.flby3 0))
(define-fun .def_855 () Bool (= call_firefly.flby2 call_firefly.mem_invalid))
(define-fun .def_851 () Bool (= param_i_invalid call_firefly.flby))
(define-fun .def_846 () Bool (= call_firefly.ite25 0))
(define-fun .def_845 () Bool (not call_firefly.garde8))
(define-fun .def_847 () Bool (or .def_845 .def_846))
(define-fun .def_841 () Bool (= call_firefly.ite15 1))
(define-fun .def_839 () Bool (not call_firefly.garde6))
(define-fun .def_842 () Bool (or .def_839 .def_841))
(define-fun .def_835 () Bool (= call_firefly.ite22 0))
(define-fun .def_833 () Bool (not call_firefly.garde3))
...
(define-fun .def_822 () Bool (= call_firefly.ite35 call_firefly.ite36))
(define-fun .def_823 () Bool (or .def_813 .def_822))
(define-fun .def_817 () Bool (= call_firefly.ite6 call_firefly.ite7))
(define-fun .def_818 () Bool (or .def_813 .def_817))
(define-fun .def_811 () Bool (= call_firefly.ite25 call_firefly.ite26))
...
(define-fun .def_1104 () Bool (and .def_871 .def_1103))
(assert .def_1104)
