...
(define-fun .def_919 () Bool (and param_e_s1.next param_e_s2.next))
(define-fun .def_918 () Bool (and param_e_s3.next param_e_s1.next))
...
(define-fun .def_646 () Bool (and param_e_s1 param_e_s2))
(define-fun .def_645 () Bool (and param_e_s3 param_e_s1))
...
(define-fun .def_816 () Bool (or call_Sofar.Sofar .def_815))
