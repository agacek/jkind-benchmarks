...
(define-fun .def_486 () Bool (= call_voiture.second.next second.next))
(define-fun .def_483 () Bool (= call_voiture.move.next move.next))
(define-fun .def_480 () Bool (= time.next call_voiture.time.next))
(define-fun .def_476 () Bool (= speed.next call_voiture.speed.next))
(define-fun .def_472 () Bool (= dist.next call_voiture.dist.next))
(define-fun .def_469 () Bool (= bump.next call_voiture.bump.next))
(define-fun .def_465 () Bool (= stop.next call_voiture.stop.next))
(define-fun .def_461 () Bool (= toofast.next call_voiture.toofast.next))
(define-fun .def_456 () Bool (<= 0 dist.next))
(define-fun .def_455 () Bool (not env.next))
(define-fun .def_457 () Bool (or .def_455 .def_456))
(define-fun .def_458 () Bool (= _OK_.next .def_457))
...
(define-fun .def_530 () Bool (and .def_381 .def_529))
(define-fun .def_445 () Bool (<= 32767 dist.next))
(define-fun .def_446 () Bool (not .def_445))
(define-fun .def_448 () Bool (and .def_446 call_excludes2.excludes.next))
(define-fun .def_449 () Bool (and call_Sofar.Sofar .def_448))
(define-fun .def_451 () Bool (= .def_449 call_Sofar.flby.next))
...
(define-fun .def_531 () Bool (and .def_452 .def_530))
(assert .def_531)
