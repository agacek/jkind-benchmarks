...
(define-fun .def_334 () Bool (= late.next call_speed.late.next))
...
(define-fun .def_307 () Bool (not call_speed.late))
(define-fun .def_304 () Bool (<= 0 call_speed.diff.next))
(define-fun .def_305 () Bool (not .def_304))
(define-fun .def_306 () Bool (= call_speed.ite4.next .def_305))
(define-fun .def_308 () Bool (or .def_306 .def_307))
(define-fun .def_300 () Bool (<= call_speed.diff.next (- 10)))
(define-fun .def_302 () Bool (= .def_300 call_speed.ite4.next))
(define-fun .def_303 () Bool (or call_speed.late .def_302))
(define-fun .def_309 () Bool (and .def_303 .def_308))
(define-fun .def_295 () Bool (and early late.next))
(define-fun .def_296 () Bool (not .def_295))
(define-fun .def_298 () Bool (= .def_296 flby.next))
(define-fun .def_310 () Bool (and .def_298 .def_309))
