...
(define-fun .def_379 () Bool (= param_a_init call_First.flby))
(define-fun .def_376 () Bool (= call_excludes3.excludes call_Sofar.flby))
(define-fun .def_372 () Bool (= call__PRODUCER_CONSUMMER_.flby5 0))
(define-fun .def_369 () Bool (= call__PRODUCER_CONSUMMER_.flby4 0))
(define-fun .def_366 () Bool (= param_a_init call__PRODUCER_CONSUMMER_.flby3))
(define-fun .def_362 () Bool (= call__PRODUCER_CONSUMMER_.flby2 0))
(define-fun .def_359 () Bool (= call__PRODUCER_CONSUMMER_.flby call__PRODUCER_CONSUMMER_.a))
(define-fun .def_354 () Bool (= call__PRODUCER_CONSUMMER_.ite11 call__PRODUCER_CONSUMMER_.ite10))
(define-fun .def_351 () Bool (not param_etat3))
(define-fun .def_355 () Bool (or .def_351 .def_354))
(define-fun .def_345 () Bool (= call__PRODUCER_CONSUMMER_.ite9 call__PRODUCER_CONSUMMER_.ite8))
(define-fun .def_348 () Bool (or .def_345 .def_347))
(define-fun .def_340 () Bool (= call__PRODUCER_CONSUMMER_.ite2 call__PRODUCER_CONSUMMER_.ite))
(define-fun .def_341 () Bool (or .def_334 .def_340))
(define-fun .def_335 () Bool (= flby .def_334))
(define-fun .def_337 () Bool (and .def_335 flby2))
...
(define-fun .def_452 () Bool (and .def_380 .def_451))
(assert .def_452)
