...
(define-fun .def_829 () Bool (and param_e_s1.next .def_828))
(define-fun .def_830 () Bool (and param_e_s3.next .def_829))
(define-fun .def_831 () Bool (and param_e_s2.next .def_830))
(define-fun .def_832 () Bool (and param_e_s3.next .def_831))
...
(define-fun .def_585 () Bool (and param_e_s2 .def_584))
