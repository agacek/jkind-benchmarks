...
(define-fun .def_427 () Bool (= call_voiture.time call_voiture.ite4.next))
(define-fun .def_431 () Bool (or .def_427 .def_430))
(define-fun .def_429 () Bool (or .def_427 call_voiture.second.next))
(define-fun .def_432 () Bool (and .def_429 .def_431))
(define-fun .def_420 () Int (* (- 1) call_voiture.ite.next))
(define-fun .def_421 () Int (+ call_voiture.dist .def_420))
(define-fun .def_422 () Bool (= .def_421 (- 1)))
(define-fun .def_409 () Bool (and call_voiture.move.next call_voiture.meter.next))
(define-fun .def_414 () Bool (not .def_409))
(define-fun .def_423 () Bool (or .def_414 .def_422))
(define-fun .def_418 () Bool (= call_voiture.dist call_voiture.ite.next))
(define-fun .def_419 () Bool (or .def_409 .def_418))
(define-fun .def_424 () Bool (and .def_419 .def_423))
(define-fun .def_411 () Int (* (- 1) call_voiture.ite2.next))
(define-fun .def_412 () Int (+ call_voiture.speed .def_411))
