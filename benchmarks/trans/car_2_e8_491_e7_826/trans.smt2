...
(define-fun .def_503 () Bool (and call_voiture.second.next .def_502))
...
(define-fun .def_338 () Bool (and call_voiture.second .def_337))
...
(define-fun .def_439 () Bool (or call_Sofar.Sofar call_excludes2.excludes.next))
