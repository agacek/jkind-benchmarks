...
(let ((.def_280 (= call_voiture.speed call_voiture.ite_keyword2.next)))
(let ((.def_270 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_281 (or .def_270 .def_280)))
(let ((.def_276 (* (- 1) call_voiture.ite_keyword2.next)))
...
(let ((.def_273 (= call_voiture.dist call_voiture.ite_keyword.next)))
(let ((.def_274 (or .def_270 .def_273)))
(let ((.def_267 (* (- 1) call_voiture.ite_keyword.next)))
...
(let ((.def_264 (= call_voiture.time call_voiture.ite_keyword4.next)))
