...
(let ((.def_280 (= call_voiture.speed call_voiture.ite2.next)))
(let ((.def_270 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_281 (or .def_270 .def_280)))
(let ((.def_276 (* (- 1) call_voiture.ite2.next)))
(let ((.def_277 (+ call_voiture.speed .def_276)))
(let ((.def_278 (= .def_277 1)))
(let ((.def_271 (not .def_270)))
(let ((.def_279 (or .def_271 .def_278)))
(let ((.def_282 (and .def_279 .def_281)))
(let ((.def_273 (= call_voiture.dist call_voiture.ite.next)))
(let ((.def_274 (or .def_270 .def_273)))
(let ((.def_267 (* (- 1) call_voiture.ite.next)))
(let ((.def_268 (+ call_voiture.dist .def_267)))
(let ((.def_269 (= .def_268 (- 1))))
(let ((.def_272 (or .def_269 .def_271)))
(let ((.def_275 (and .def_272 .def_274)))
(let ((.def_283 (and .def_275 .def_282)))
(let ((.def_264 (= call_voiture.time call_voiture.ite4.next)))
(let ((.def_265 (or call_voiture.second.next .def_264)))
(let ((.def_258 (* (- 1) call_voiture.ite4.next)))
(let ((.def_259 (+ call_voiture.time .def_258)))
(let ((.def_262 (= .def_259 (- 2))))
