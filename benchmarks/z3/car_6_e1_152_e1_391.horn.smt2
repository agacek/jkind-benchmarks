...
(let ((.def_240 (* (- 1) call_voiture.ite2.next)))
(let ((.def_241 (+ call_voiture.speed .def_240)))
(let ((.def_242 (= .def_241 (- 2))))
(let ((.def_245 (or .def_242 .def_244)))
(let ((.def_248 (and .def_245 .def_247)))
(let ((.def_259 (and .def_248 .def_258)))
(let ((.def_237 (= call_voiture.time call_voiture.ite4.next)))
(let ((.def_238 (or call_voiture.second.next .def_237)))
(let ((.def_231 (* (- 1) call_voiture.ite4.next)))
(let ((.def_232 (+ call_voiture.time .def_231)))
(let ((.def_235 (= .def_232 (- 2))))
