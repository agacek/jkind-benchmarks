...
(let ((.def_234 (and call_voiture.meter.next call_voiture.move.next)))
...
(let ((.def_239 (not bump)))
(let ((.def_240 (= flby.next .def_239)))
(let ((.def_250 (and .def_240 .def_249)))
(let ((.def_233 (= call_voiture.speed call_voiture.ite2.next)))
...
(let ((.def_229 (= call_voiture.time call_voiture.ite4.next)))
(let ((.def_231 (or call_voiture.second.next .def_229)))
