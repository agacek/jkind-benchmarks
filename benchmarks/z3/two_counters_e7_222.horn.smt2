...
(declare-var |call_intloopcounter.ite| Int)
(declare-var |call_intloopcounter.ite.next| Int)
...
(let ((.def_28 (or call_greycounter.b call_greycounter.a)))
...
(let ((.def_91 (not call_greycounter.b)))
(let ((.def_92 (= call_greycounter.flby.next .def_91)))
(let ((.def_90 (= call_greycounter.a call_greycounter.flby2.next)))
(let ((.def_93 (and .def_90 .def_92)))
(let ((.def_85 (* (- 1) call_intloopcounter.ite.next)))
(let ((.def_86 (+ call_intloopcounter.time .def_85)))
(let ((.def_87 (= .def_86 (- 1))))
(let ((.def_79 (= call_intloopcounter.time 3)))
(let ((.def_88 (or .def_79 .def_87)))
(let ((.def_81 (= call_intloopcounter.ite.next 0)))
(let ((.def_80 (not .def_79)))
(let ((.def_82 (or .def_80 .def_81)))
(let ((.def_89 (and .def_82 .def_88)))
(let ((.def_94 (and .def_89 .def_93)))
(let ((.def_77 (= call_intloopcounter.flby.next call_intloopcounter.ite.next)))
...
(let ((.def_58 (or call_greycounter.b.next call_greycounter.a.next)))
...
(rule (=> .init (state |_OK_| |b| |call_greycounter.a| |call_greycounter.b| |call_greycounter.flby| |call_greycounter.flby2| |call_greycounter.out| |call_intloopcounter.flby| |call_intloopcounter.ite| |call_intloopcounter.out| |call_intloopcounter.time| |d|)))
(rule (=> (and (state |_OK_| |b| |call_greycounter.a| |call_greycounter.b| |call_greycounter.flby| |call_greycounter.flby2| |call_greycounter.out| |call_intloopcounter.flby| |call_intloopcounter.ite| |call_intloopcounter.out| |call_intloopcounter.time| |d|) .trans) (state |_OK_.next| |b.next| |call_greycounter.a.next| |call_greycounter.b.next| |call_greycounter.flby.next| |call_greycounter.flby2.next| |call_greycounter.out.next| |call_intloopcounter.flby.next| |call_intloopcounter.ite.next| |call_intloopcounter.out.next| |call_intloopcounter.time.next| |d.next|)))
(query (and (state |_OK_| |b| |call_greycounter.a| |call_greycounter.b| |call_greycounter.flby| |call_greycounter.flby2| |call_greycounter.out| |call_intloopcounter.flby| |call_intloopcounter.ite| |call_intloopcounter.out| |call_intloopcounter.time| |d|) (not .property)))
