...
(let ((.def_388 (= call_synapse.invalid_s call_synapse.ite_keyword.next)))
(let ((.def_389 (or call_synapse.garde_s1.next .def_388)))
(let ((.def_381 (* (- 1) call_synapse.ite_keyword.next)))
(let ((.def_384 (+ call_synapse.invalid_s .def_381)))
...
(let ((.def_376 (+ call_synapse.invalid_s .def_371)))
(let ((.def_377 (+ call_synapse.valid_s .def_376)))
(let ((.def_378 (+ call_synapse.dirty_s .def_377)))
(let ((.def_379 (= .def_378 2)))
