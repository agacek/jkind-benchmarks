...
(let ((.def_150 (= call_synapse.ite10 call_synapse.ite9)))
(let ((.def_145 (not param_e_s3)))
(let ((.def_151 (or .def_145 .def_150)))
(let ((.def_148 (= call_synapse.ite4 call_synapse.ite3)))
(let ((.def_149 (or .def_145 .def_148)))
(let ((.def_152 (and .def_149 .def_151)))
(let ((.def_144 (= call_synapse.ite16 call_synapse.ite15)))
...
(let ((.def_394 (= call_synapse.invalid_s call_synapse.ite4.next)))
(let ((.def_395 (or param_e_s3.next .def_394)))
(let ((.def_392 (= call_synapse.ite4.next call_synapse.ite3.next)))
(let ((.def_386 (not param_e_s3.next)))
(let ((.def_393 (or .def_386 .def_392)))
(let ((.def_396 (and .def_393 .def_395)))
(let ((.def_390 (= call_synapse.ite10.next call_synapse.ite9.next)))
(let ((.def_391 (or .def_386 .def_390)))
(let ((.def_397 (and .def_391 .def_396)))
(let ((.def_388 (= call_synapse.valid_s call_synapse.ite10.next)))
(let ((.def_389 (or param_e_s3.next .def_388)))
(let ((.def_398 (and .def_389 .def_397)))
(let ((.def_385 (= call_synapse.ite16.next call_synapse.ite15.next)))
(let ((.def_387 (or .def_385 .def_386)))
(let ((.def_399 (and .def_387 .def_398)))
(let ((.def_383 (= call_synapse.dirty_s call_synapse.ite16.next)))
...
(let ((.def_361 (= call_synapse.invalid_s call_synapse.ite.next)))
(let ((.def_362 (or call_synapse.garde_s1.next .def_361)))
(let ((.def_356 (* (- 1) call_synapse.invalid_s)))
(let ((.def_357 (+ .def_356 call_synapse.ite.next)))
...
(let ((.def_343 (* (- 1) call_synapse.ite2.next)))
...
(let ((.def_341 (= call_synapse.invalid_s call_synapse.ite2.next)))
(let ((.def_342 (or call_synapse.garde_s2.next .def_341)))
(let ((.def_365 (and .def_342 .def_364)))
(let ((.def_332 (* (- 1) call_synapse.ite3.next)))
...
(let ((.def_297 (= call_synapse.ite14.next 1)))
(let ((.def_298 (or .def_295 .def_297)))
(let ((.def_294 (= call_synapse.ite8.next 0)))
...
(let ((.def_287 (= call_synapse.ite15.next 1)))
(let ((.def_288 (or .def_284 .def_287)))
(let ((.def_283 (= call_synapse.ite9.next 0)))
...
(let ((.def_277 (= call_synapse.flby2.next call_synapse.ite6.next)))
(let ((.def_409 (and .def_277 .def_408)))
(let ((.def_276 (= call_synapse.flby3.next call_synapse.ite12.next)))
(let ((.def_410 (and .def_276 .def_409)))
(let ((.def_275 (= call_synapse.flby4.next call_synapse.ite18.next)))
