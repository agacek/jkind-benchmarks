...
(let ((.def_152 (= call_synapse.ite10 call_synapse.ite9)))
(let ((.def_147 (not param_e_s3)))
(let ((.def_153 (or .def_147 .def_152)))
(let ((.def_150 (= call_synapse.ite4 call_synapse.ite3)))
(let ((.def_151 (or .def_147 .def_150)))
(let ((.def_154 (and .def_151 .def_153)))
(let ((.def_146 (= call_synapse.ite16 call_synapse.ite15)))
(let ((.def_148 (or .def_146 .def_147)))
(let ((.def_155 (and .def_148 .def_154)))
(let ((.def_144 (not call_synapse.garde_s1)))
(let ((.def_142 (= call_synapse.ite13 0)))
(let ((.def_145 (or .def_142 .def_144)))
(let ((.def_156 (and .def_145 .def_155)))
(let ((.def_139 (= call_synapse.ite14 1)))
(let ((.def_137 (not call_synapse.garde_s2)))
(let ((.def_140 (or .def_137 .def_139)))
(let ((.def_135 (= call_synapse.ite8 0)))
(let ((.def_138 (or .def_135 .def_137)))
(let ((.def_141 (and .def_138 .def_140)))
(let ((.def_157 (and .def_141 .def_156)))
(let ((.def_132 (= call_synapse.ite15 1)))
(let ((.def_128 (not call_synapse.garde_s3)))
(let ((.def_133 (or .def_128 .def_132)))
(let ((.def_126 (= call_synapse.ite9 0)))
(let ((.def_129 (or .def_126 .def_128)))
(let ((.def_134 (and .def_129 .def_133)))
(let ((.def_158 (and .def_134 .def_157)))
(let ((.def_124 (= call_synapse.flby param_init_invalid_s)))
(let ((.def_159 (and .def_124 .def_158)))
(let ((.def_123 (= call_synapse.mem_init_s call_synapse.flby2)))
(let ((.def_160 (and .def_123 .def_159)))
(let ((.def_122 (= call_synapse.flby3 0)))
(let ((.def_161 (and .def_122 .def_160)))
(let ((.def_121 (= call_synapse.flby4 0)))
(let ((.def_162 (and .def_121 .def_161)))
(let ((.def_118 (<= 0 param_init_invalid_s)))
(let ((.def_119 (and call_excludes3.excludes .def_118)))
(let ((.def_120 (= call_Sofar.flby .def_119)))
(let ((.def_163 (and .def_120 .def_162)))
(let ((.def_99 (not env)))
(let ((.def_97 (<= 2 dirty_s)))
(let ((.def_98 (not .def_97)))
(let ((.def_100 (or .def_98 .def_99)))
(let ((.def_102 (= .def_100 _OK_)))
...
(let ((.def_379 (= call_synapse.invalid_s call_synapse.ite.next)))
(let ((.def_380 (or call_synapse.garde_s1.next .def_379)))
(let ((.def_372 (* (- 1) call_synapse.ite.next)))
(let ((.def_375 (+ call_synapse.invalid_s .def_372)))
(let ((.def_376 (+ call_synapse.dirty_s .def_375)))
(let ((.def_377 (= .def_376 1)))
(let ((.def_306 (not call_synapse.garde_s1.next)))
(let ((.def_378 (or .def_306 .def_377)))
(let ((.def_381 (and .def_378 .def_380)))
(let ((.def_363 (* (- 1) call_synapse.ite2.next)))
(let ((.def_367 (+ call_synapse.invalid_s .def_363)))
(let ((.def_368 (+ call_synapse.valid_s .def_367)))
(let ((.def_369 (+ call_synapse.dirty_s .def_368)))
(let ((.def_370 (= .def_369 1)))
(let ((.def_297 (not call_synapse.garde_s2.next)))
(let ((.def_371 (or .def_297 .def_370)))
(let ((.def_382 (and .def_371 .def_381)))
(let ((.def_361 (= call_synapse.invalid_s call_synapse.ite2.next)))
(let ((.def_362 (or call_synapse.garde_s2.next .def_361)))
(let ((.def_383 (and .def_362 .def_382)))
(let ((.def_352 (* (- 1) call_synapse.ite3.next)))
(let ((.def_356 (+ call_synapse.invalid_s .def_352)))
(let ((.def_357 (+ call_synapse.valid_s .def_356)))
(let ((.def_358 (+ call_synapse.dirty_s .def_357)))
(let ((.def_359 (= .def_358 1)))
(let ((.def_286 (not call_synapse.garde_s3.next)))
(let ((.def_360 (or .def_286 .def_359)))
(let ((.def_384 (and .def_360 .def_383)))
(let ((.def_350 (= call_synapse.invalid_s call_synapse.ite3.next)))
(let ((.def_351 (or call_synapse.garde_s3.next .def_350)))
(let ((.def_385 (and .def_351 .def_384)))
(let ((.def_343 (= call_synapse.invalid_s call_synapse.ite4.next)))
(let ((.def_344 (or param_e_s3.next .def_343)))
(let ((.def_341 (= call_synapse.ite4.next call_synapse.ite3.next)))
(let ((.def_334 (not param_e_s3.next)))
(let ((.def_342 (or .def_334 .def_341)))
(let ((.def_345 (and .def_342 .def_344)))
(let ((.def_338 (= call_synapse.ite10.next call_synapse.ite9.next)))
(let ((.def_339 (or .def_334 .def_338)))
(let ((.def_346 (and .def_339 .def_345)))
(let ((.def_336 (= call_synapse.valid_s call_synapse.ite10.next)))
(let ((.def_337 (or param_e_s3.next .def_336)))
(let ((.def_347 (and .def_337 .def_346)))
(let ((.def_333 (= call_synapse.ite16.next call_synapse.ite15.next)))
(let ((.def_335 (or .def_333 .def_334)))
(let ((.def_348 (and .def_335 .def_347)))
(let ((.def_331 (= call_synapse.dirty_s call_synapse.ite16.next)))
(let ((.def_332 (or param_e_s3.next .def_331)))
(let ((.def_349 (and .def_332 .def_348)))
(let ((.def_386 (and .def_349 .def_385)))
(let ((.def_326 (= call_synapse.valid_s call_synapse.ite7.next)))
(let ((.def_327 (or call_synapse.garde_s1.next .def_326)))
(let ((.def_322 (* (- 1) call_synapse.ite7.next)))
(let ((.def_323 (+ call_synapse.valid_s .def_322)))
(let ((.def_324 (= .def_323 (- 1))))
(let ((.def_325 (or .def_306 .def_324)))
(let ((.def_328 (and .def_325 .def_327)))
(let ((.def_319 (= call_synapse.valid_s call_synapse.ite8.next)))
(let ((.def_320 (or call_synapse.garde_s2.next .def_319)))
(let ((.def_329 (and .def_320 .def_328)))
(let ((.def_317 (= call_synapse.valid_s call_synapse.ite9.next)))
(let ((.def_318 (or call_synapse.garde_s3.next .def_317)))
(let ((.def_330 (and .def_318 .def_329)))
(let ((.def_387 (and .def_330 .def_386)))
(let ((.def_313 (= call_synapse.dirty_s call_synapse.ite14.next)))
(let ((.def_314 (or call_synapse.garde_s2.next .def_313)))
(let ((.def_311 (= call_synapse.dirty_s call_synapse.ite13.next)))
(let ((.def_312 (or call_synapse.garde_s1.next .def_311)))
(let ((.def_315 (and .def_312 .def_314)))
(let ((.def_309 (= call_synapse.dirty_s call_synapse.ite15.next)))
(let ((.def_310 (or call_synapse.garde_s3.next .def_309)))
(let ((.def_316 (and .def_310 .def_315)))
(let ((.def_388 (and .def_316 .def_387)))
(let ((.def_305 (= call_synapse.ite13.next 0)))
(let ((.def_307 (or .def_305 .def_306)))
(let ((.def_281 (<= 1 call_synapse.invalid_s)))
(let ((.def_304 (= .def_281 call_synapse.garde_s1.next)))
(let ((.def_308 (and .def_304 .def_307)))
(let ((.def_389 (and .def_308 .def_388)))
(let ((.def_299 (= call_synapse.ite14.next 1)))
(let ((.def_300 (or .def_297 .def_299)))
(let ((.def_296 (= call_synapse.ite8.next 0)))
(let ((.def_298 (or .def_296 .def_297)))
(let ((.def_301 (and .def_298 .def_300)))
(let ((.def_293 (<= 1 call_synapse.valid_s)))
(let ((.def_295 (= .def_293 call_synapse.garde_s2.next)))
(let ((.def_302 (and .def_295 .def_301)))
(let ((.def_390 (and .def_302 .def_389)))
(let ((.def_289 (= call_synapse.ite15.next 1)))
(let ((.def_290 (or .def_286 .def_289)))
(let ((.def_285 (= call_synapse.ite9.next 0)))
(let ((.def_287 (or .def_285 .def_286)))
(let ((.def_291 (and .def_287 .def_290)))
(let ((.def_283 (= .def_281 call_synapse.garde_s3.next)))
(let ((.def_292 (and .def_283 .def_291)))
(let ((.def_391 (and .def_292 .def_390)))
(let ((.def_280 (= call_synapse.mem_init_s call_synapse.flby.next)))
(let ((.def_392 (and .def_280 .def_391)))
(let ((.def_279 (= call_synapse.flby2.next call_synapse.ite6.next)))
(let ((.def_393 (and .def_279 .def_392)))
(let ((.def_278 (= call_synapse.flby3.next call_synapse.ite12.next)))
(let ((.def_394 (and .def_278 .def_393)))
(let ((.def_277 (= call_synapse.flby4.next call_synapse.ite18.next)))
(let ((.def_395 (and .def_277 .def_394)))
(let ((.def_273 (<= 0 param_init_invalid_s.next)))
(let ((.def_274 (and call_excludes3.excludes.next .def_273)))
(let ((.def_275 (and call_Sofar.Sofar .def_274)))
(let ((.def_276 (= call_Sofar.flby.next .def_275)))
(let ((.def_396 (and .def_276 .def_395)))
(let ((.def_254 (not env.next)))
(let ((.def_252 (<= 2 dirty_s.next)))
(let ((.def_253 (not .def_252)))
(let ((.def_255 (or .def_253 .def_254)))
(let ((.def_257 (= .def_255 _OK_.next)))
(let ((.def_251 (= call_synapse.invalid_s.next invalid_s.next)))
(let ((.def_258 (and .def_251 .def_257)))
(let ((.def_249 (= call_synapse.valid_s.next valid_s.next)))
(let ((.def_259 (and .def_249 .def_258)))
(let ((.def_247 (= call_synapse.dirty_s.next dirty_s.next)))
(let ((.def_260 (and .def_247 .def_259)))
(let ((.def_245 (= call_synapse.mem_init_s.next mem_init_s.next)))
(let ((.def_261 (and .def_245 .def_260)))
(let ((.def_243 (= call_Sofar.Sofar.next env.next)))
(let ((.def_262 (and .def_243 .def_261)))
(let ((.def_235 (= call_synapse.ite5.next call_synapse.ite6.next)))
(let ((.def_236 (or param_e_s1.next .def_235)))
(let ((.def_233 (= call_synapse.ite.next call_synapse.ite6.next)))
(let ((.def_223 (not param_e_s1.next)))
(let ((.def_234 (or .def_223 .def_233)))
(let ((.def_237 (and .def_234 .def_236)))
(let ((.def_229 (= call_synapse.ite12.next call_synapse.ite7.next)))
(let ((.def_230 (or .def_223 .def_229)))
(let ((.def_238 (and .def_230 .def_237)))
(let ((.def_226 (= call_synapse.ite11.next call_synapse.ite12.next)))
(let ((.def_227 (or param_e_s1.next .def_226)))
(let ((.def_239 (and .def_227 .def_238)))
(let ((.def_222 (= call_synapse.ite18.next call_synapse.ite13.next)))
(let ((.def_224 (or .def_222 .def_223)))
(let ((.def_240 (and .def_224 .def_239)))
(let ((.def_219 (= call_synapse.ite17.next call_synapse.ite18.next)))
(let ((.def_220 (or param_e_s1.next .def_219)))
(let ((.def_241 (and .def_220 .def_240)))
(let ((.def_263 (and .def_241 .def_262)))
(let ((.def_211 (= call_synapse.ite5.next call_synapse.ite4.next)))
(let ((.def_212 (or param_e_s2.next .def_211)))
(let ((.def_208 (= call_synapse.ite2.next call_synapse.ite5.next)))
(let ((.def_197 (not param_e_s2.next)))
(let ((.def_209 (or .def_197 .def_208)))
(let ((.def_213 (and .def_209 .def_212)))
(let ((.def_204 (= call_synapse.ite11.next call_synapse.ite8.next)))
(let ((.def_205 (or .def_197 .def_204)))
(let ((.def_214 (and .def_205 .def_213)))
(let ((.def_201 (= call_synapse.ite10.next call_synapse.ite11.next)))
(let ((.def_202 (or param_e_s2.next .def_201)))
(let ((.def_215 (and .def_202 .def_214)))
(let ((.def_196 (= call_synapse.ite17.next call_synapse.ite14.next)))
(let ((.def_198 (or .def_196 .def_197)))
(let ((.def_216 (and .def_198 .def_215)))
(let ((.def_193 (= call_synapse.ite16.next call_synapse.ite17.next)))
(let ((.def_194 (or param_e_s2.next .def_193)))
(let ((.def_217 (and .def_194 .def_216)))
(let ((.def_264 (and .def_217 .def_263)))
(let ((.def_190 (= call_synapse.flby2.next call_synapse.invalid_s.next)))
(let ((.def_265 (and .def_190 .def_264)))
(let ((.def_187 (= call_synapse.flby3.next call_synapse.valid_s.next)))
(let ((.def_266 (and .def_187 .def_265)))
(let ((.def_184 (= call_synapse.flby4.next call_synapse.dirty_s.next)))
(let ((.def_267 (and .def_184 .def_266)))
(let ((.def_181 (= call_synapse.flby.next call_synapse.mem_init_s.next)))
(let ((.def_268 (and .def_181 .def_267)))
(let ((.def_173 (and param_e_s2.next param_e_s1.next)))
(let ((.def_172 (and param_e_s3.next param_e_s1.next)))
(let ((.def_174 (or .def_172 .def_173)))
(let ((.def_170 (and param_e_s3.next param_e_s2.next)))
(let ((.def_175 (or .def_170 .def_174)))
(let ((.def_176 (not .def_175)))
(let ((.def_178 (= .def_176 call_excludes3.excludes.next)))
(let ((.def_269 (and .def_178 .def_268)))
(let ((.def_167 (= call_Sofar.flby.next call_Sofar.Sofar.next)))
