...
(declare-var |call_sustain.Aite| Bool)
(declare-var |call_sustain.Aite.next| Bool)
(declare-var |call_sustain.Aite2| Bool)
(declare-var |call_sustain.Aite2.next| Bool)
...
(declare-var |Aite| Bool)
(declare-var |Aite.next| Bool)
(declare-var |Aite2| Bool)
(declare-var |Aite2.next| Bool)
...
(let ((.def_122 (not call_sustain.Aite)))
(let ((.def_60 (not stop)))
...
(let ((.def_77 (= call_sustain.Aite2 call_sustain.Aite)))
(let ((.def_78 (or .def_72 .def_77)))
(let ((.def_73 (not .def_72)))
(let ((.def_75 (or .def_73 call_sustain.Aite2)))
...
(let ((.def_69 (and Aite .def_68)))
(let ((.def_70 (= Aite2 .def_69)))
...
(let ((.def_46 (or moving Aite)))
(let ((.def_44 (= param_MaySafelyMove Aite)))
...
(let ((.def_264 (= call_sustain.s call_sustain.Aite.next)))
(let ((.def_265 (or stop.next .def_264)))
(let ((.def_262 (not call_sustain.Aite.next)))
...
(let ((.def_259 (= Aite2.next flby3.next)))
(let ((.def_269 (and .def_259 .def_268)))
(let ((.def_258 (= call_sustain.flby.next call_sustain.Aite2.next)))
...
(let ((.def_203 (= call_sustain.Aite2.next call_sustain.Aite.next)))
(let ((.def_198 (or start2.next start1.next)))
(let ((.def_204 (or .def_198 .def_203)))
(let ((.def_199 (not .def_198)))
(let ((.def_201 (or .def_199 call_sustain.Aite2.next)))
...
(let ((.def_195 (and Aite.next .def_194)))
(let ((.def_196 (= Aite2.next .def_195)))
...
(let ((.def_172 (or moving.next Aite.next)))
(let ((.def_170 (= param_MaySafelyMove.next Aite.next)))
...
(let ((.def_164 (or .def_162 Aite2.next)))
...
(rule (=> .init (state |MayMove1| |MayMove2| |_OK_| |call_fedge.call_redge.flby| |call_fedge.call_redge.r| |call_fedge.f| |call_fedge2.call_redge.flby| |call_fedge2.call_redge.r| |call_fedge2.f| |call_redge.flby| |call_redge.r| |call_redge2.flby| |call_redge2.r| |call_redge3.flby| |call_redge3.r| |call_redge4.flby| |call_redge4.r| |call_sustain.flby| |call_sustain.Aite| |call_sustain.Aite2| |call_sustain.s| |flby| |flby2| |flby3| |Aite| |Aite2| |moving| |param_MaySafelyMove| |param_TryToMove1| |param_TryToMove2| |start1| |start2| |stop|)))
(rule (=> (and (state |MayMove1| |MayMove2| |_OK_| |call_fedge.call_redge.flby| |call_fedge.call_redge.r| |call_fedge.f| |call_fedge2.call_redge.flby| |call_fedge2.call_redge.r| |call_fedge2.f| |call_redge.flby| |call_redge.r| |call_redge2.flby| |call_redge2.r| |call_redge3.flby| |call_redge3.r| |call_redge4.flby| |call_redge4.r| |call_sustain.flby| |call_sustain.Aite| |call_sustain.Aite2| |call_sustain.s| |flby| |flby2| |flby3| |Aite| |Aite2| |moving| |param_MaySafelyMove| |param_TryToMove1| |param_TryToMove2| |start1| |start2| |stop|) .trans) (state |MayMove1.next| |MayMove2.next| |_OK_.next| |call_fedge.call_redge.flby.next| |call_fedge.call_redge.r.next| |call_fedge.f.next| |call_fedge2.call_redge.flby.next| |call_fedge2.call_redge.r.next| |call_fedge2.f.next| |call_redge.flby.next| |call_redge.r.next| |call_redge2.flby.next| |call_redge2.r.next| |call_redge3.flby.next| |call_redge3.r.next| |call_redge4.flby.next| |call_redge4.r.next| |call_sustain.flby.next| |call_sustain.Aite.next| |call_sustain.Aite2.next| |call_sustain.s.next| |flby.next| |flby2.next| |flby3.next| |Aite.next| |Aite2.next| |moving.next| |param_MaySafelyMove.next| |param_TryToMove1.next| |param_TryToMove2.next| |start1.next| |start2.next| |stop.next|)))
(query (and (state |MayMove1| |MayMove2| |_OK_| |call_fedge.call_redge.flby| |call_fedge.call_redge.r| |call_fedge.f| |call_fedge2.call_redge.flby| |call_fedge2.call_redge.r| |call_fedge2.f| |call_redge.flby| |call_redge.r| |call_redge2.flby| |call_redge2.r| |call_redge3.flby| |call_redge3.r| |call_redge4.flby| |call_redge4.r| |call_sustain.flby| |call_sustain.Aite| |call_sustain.Aite2| |call_sustain.s| |flby| |flby2| |flby3| |Aite| |Aite2| |moving| |param_MaySafelyMove| |param_TryToMove1| |param_TryToMove2| |start1| |start2| |stop|) (not .property)))
