...
(let ((.def_253 (= call_voiture.dist call_voiture.ite_keyword.next)))
(let ((.def_241 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_254 (or .def_241 .def_253)))
(let ((.def_249 (* (- 1) call_voiture.ite_keyword.next)))
...
(let ((.def_244 (= call_voiture.speed call_voiture.ite_keyword2.next)))
