...
(let ((.def_253 (= call_voiture.dist call_voiture.ite.next)))
(let ((.def_241 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_254 (or .def_241 .def_253)))
(let ((.def_249 (* (- 1) call_voiture.ite.next)))
(let ((.def_250 (+ call_voiture.dist .def_249)))
(let ((.def_251 (= .def_250 (- 1))))
(let ((.def_242 (not .def_241)))
(let ((.def_252 (or .def_242 .def_251)))
(let ((.def_255 (and .def_252 .def_254)))
(let ((.def_247 (not bump)))
(let ((.def_248 (= flby.next .def_247)))
(let ((.def_256 (and .def_248 .def_255)))
(let ((.def_244 (= call_voiture.speed call_voiture.ite2.next)))
