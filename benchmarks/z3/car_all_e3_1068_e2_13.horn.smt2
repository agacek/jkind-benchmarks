...
(let ((.def_275 (= call_voiture.speed call_voiture.ite_keyword2.next)))
(let ((.def_265 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_276 (or .def_265 .def_275)))
(let ((.def_271 (* (- 1) call_voiture.ite_keyword2.next)))
...
(let ((.def_268 (= call_voiture.dist call_voiture.ite_keyword.next)))
(let ((.def_269 (or .def_265 .def_268)))
(let ((.def_262 (* (- 1) call_voiture.ite_keyword.next)))
...
(let ((.def_256 (= call_voiture.time call_voiture.ite_keyword4.next)))
