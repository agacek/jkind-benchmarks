...
(let ((.def_393 (= call_synapse.invalid_s call_synapse.ite4.next)))
(let ((.def_394 (or param_e_s3.next .def_393)))
(let ((.def_391 (= call_synapse.ite4.next call_synapse.ite3.next)))
(let ((.def_385 (not param_e_s3.next)))
(let ((.def_392 (or .def_385 .def_391)))
(let ((.def_395 (and .def_392 .def_394)))
(let ((.def_389 (= call_synapse.ite10.next call_synapse.ite9.next)))
(let ((.def_390 (or .def_385 .def_389)))
(let ((.def_396 (and .def_390 .def_395)))
(let ((.def_387 (= call_synapse.valid_s call_synapse.ite10.next)))
(let ((.def_388 (or param_e_s3.next .def_387)))
(let ((.def_397 (and .def_388 .def_396)))
(let ((.def_384 (= call_synapse.ite16.next call_synapse.ite15.next)))
(let ((.def_386 (or .def_384 .def_385)))
(let ((.def_398 (and .def_386 .def_397)))
(let ((.def_382 (= call_synapse.dirty_s call_synapse.ite16.next)))
(let ((.def_383 (or param_e_s3.next .def_382)))
(let ((.def_399 (and .def_383 .def_398)))
(let ((.def_370 (* (- 1) invalid_s.next)))
(let ((.def_368 (* (- 1) valid_s.next)))
(let ((.def_375 (+ .def_368 .def_370)))
(let ((.def_367 (* (- 1) dirty_s.next)))
(let ((.def_376 (+ .def_367 .def_375)))
(let ((.def_377 (+ invalid_s .def_376)))
(let ((.def_378 (+ valid_s .def_377)))
(let ((.def_379 (+ dirty_s .def_378)))
(let ((.def_380 (= .def_379 0)))
(let ((.def_381 (= flby.next .def_380)))
(let ((.def_400 (and .def_381 .def_399)))
(let ((.def_360 (= call_synapse.invalid_s call_synapse.ite.next)))
(let ((.def_361 (or call_synapse.garde_s1.next .def_360)))
(let ((.def_352 (* (- 1) call_synapse.ite.next)))
(let ((.def_356 (+ call_synapse.invalid_s .def_352)))
(let ((.def_357 (+ call_synapse.dirty_s .def_356)))
(let ((.def_358 (= .def_357 2)))
