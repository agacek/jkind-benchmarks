...
(let ((.def_22 (not b)))
(let ((.def_30 (and a .def_22)))
(let ((.def_27 (not c)))
(let ((.def_31 (and .def_27 .def_30)))
(let ((.def_24 (not a)))
(let ((.def_26 (and b .def_24)))
(let ((.def_28 (and .def_26 .def_27)))
(let ((.def_23 (and c .def_22)))
...
(let ((.def_53 (not b.next)))
(let ((.def_61 (and a.next .def_53)))
(let ((.def_58 (not c.next)))
(let ((.def_62 (and .def_58 .def_61)))
(let ((.def_55 (not a.next)))
(let ((.def_57 (and b.next .def_55)))
(let ((.def_59 (and .def_57 .def_58)))
(let ((.def_54 (and c.next .def_53)))
