...
(let ((.def_469 (= call__main_.call_hypothese2.c call__main_.call_hypothese2.ite_keyword3.next)))
(let ((.def_467 (not param__B1_.next)))
(let ((.def_474 (or .def_467 .def_469)))
(let ((.def_472 (= call__main_.call_hypothese2.ite_keyword2.next .def_467)))
