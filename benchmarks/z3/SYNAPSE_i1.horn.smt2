...
(let ((.def_155 (= call_synapse.ite_keyword10 call_synapse.ite_keyword9)))
(let ((.def_150 (not param_e_s3)))
(let ((.def_156 (or .def_150 .def_155)))
(let ((.def_153 (= call_synapse.ite_keyword4 call_synapse.ite_keyword3)))
(let ((.def_154 (or .def_150 .def_153)))
(let ((.def_157 (and .def_154 .def_156)))
(let ((.def_149 (= call_synapse.ite_keyword16 call_synapse.ite_keyword15)))
(let ((.def_151 (or .def_149 .def_150)))
(let ((.def_158 (and .def_151 .def_157)))
(let ((.def_147 (not call_synapse.garde_s1)))
(let ((.def_145 (= call_synapse.ite_keyword13 0)))
(let ((.def_148 (or .def_145 .def_147)))
(let ((.def_159 (and .def_148 .def_158)))
(let ((.def_142 (= call_synapse.ite_keyword14 1)))
(let ((.def_140 (not call_synapse.garde_s2)))
(let ((.def_143 (or .def_140 .def_142)))
(let ((.def_138 (= call_synapse.ite_keyword8 0)))
(let ((.def_141 (or .def_138 .def_140)))
(let ((.def_144 (and .def_141 .def_143)))
(let ((.def_160 (and .def_144 .def_159)))
(let ((.def_135 (= call_synapse.ite_keyword15 1)))
(let ((.def_132 (not call_synapse.garde_s3)))
(let ((.def_136 (or .def_132 .def_135)))
(let ((.def_130 (= call_synapse.ite_keyword9 0)))
(let ((.def_133 (or .def_130 .def_132)))
(let ((.def_137 (and .def_133 .def_136)))
(let ((.def_161 (and .def_137 .def_160)))
(let ((.def_128 (= call_synapse.flby param_init_invalid_s)))
(let ((.def_162 (and .def_128 .def_161)))
(let ((.def_127 (= call_synapse.mem_init_s call_synapse.flby2)))
(let ((.def_163 (and .def_127 .def_162)))
(let ((.def_126 (= call_synapse.flby3 0)))
(let ((.def_164 (and .def_126 .def_163)))
(let ((.def_125 (= call_synapse.flby4 0)))
(let ((.def_165 (and .def_125 .def_164)))
(let ((.def_122 (<= 0 param_init_invalid_s)))
(let ((.def_123 (and call_excludes3.excludes .def_122)))
(let ((.def_124 (= call_Sofar.flby .def_123)))
(let ((.def_166 (and .def_124 .def_165)))
(let ((.def_103 (not env)))
(let ((.def_100 (<= 1 dirty_s)))
(let ((.def_101 (not .def_100)))
(let ((.def_97 (<= 2 invalid_s)))
...
(let ((.def_385 (= call_synapse.invalid_s call_synapse.ite_keyword.next)))
(let ((.def_386 (or call_synapse.garde_s1.next .def_385)))
(let ((.def_378 (* (- 1) call_synapse.ite_keyword.next)))
(let ((.def_381 (+ call_synapse.invalid_s .def_378)))
(let ((.def_382 (+ call_synapse.dirty_s .def_381)))
(let ((.def_383 (= .def_382 1)))
(let ((.def_312 (not call_synapse.garde_s1.next)))
(let ((.def_384 (or .def_312 .def_383)))
(let ((.def_387 (and .def_384 .def_386)))
(let ((.def_369 (* (- 1) call_synapse.ite_keyword2.next)))
(let ((.def_373 (+ call_synapse.invalid_s .def_369)))
(let ((.def_374 (+ call_synapse.valid_s .def_373)))
(let ((.def_375 (+ call_synapse.dirty_s .def_374)))
(let ((.def_376 (= .def_375 1)))
(let ((.def_303 (not call_synapse.garde_s2.next)))
(let ((.def_377 (or .def_303 .def_376)))
(let ((.def_388 (and .def_377 .def_387)))
(let ((.def_367 (= call_synapse.invalid_s call_synapse.ite_keyword2.next)))
(let ((.def_368 (or call_synapse.garde_s2.next .def_367)))
(let ((.def_389 (and .def_368 .def_388)))
(let ((.def_358 (* (- 1) call_synapse.ite_keyword3.next)))
(let ((.def_362 (+ call_synapse.invalid_s .def_358)))
(let ((.def_363 (+ call_synapse.valid_s .def_362)))
(let ((.def_364 (+ call_synapse.dirty_s .def_363)))
(let ((.def_365 (= .def_364 1)))
(let ((.def_292 (not call_synapse.garde_s3.next)))
(let ((.def_366 (or .def_292 .def_365)))
(let ((.def_390 (and .def_366 .def_389)))
(let ((.def_356 (= call_synapse.invalid_s call_synapse.ite_keyword3.next)))
(let ((.def_357 (or call_synapse.garde_s3.next .def_356)))
(let ((.def_391 (and .def_357 .def_390)))
(let ((.def_349 (= call_synapse.invalid_s call_synapse.ite_keyword4.next)))
(let ((.def_350 (or param_e_s3.next .def_349)))
(let ((.def_347 (= call_synapse.ite_keyword4.next call_synapse.ite_keyword3.next)))
(let ((.def_340 (not param_e_s3.next)))
(let ((.def_348 (or .def_340 .def_347)))
(let ((.def_351 (and .def_348 .def_350)))
(let ((.def_344 (= call_synapse.ite_keyword10.next call_synapse.ite_keyword9.next)))
(let ((.def_345 (or .def_340 .def_344)))
(let ((.def_352 (and .def_345 .def_351)))
(let ((.def_342 (= call_synapse.valid_s call_synapse.ite_keyword10.next)))
(let ((.def_343 (or param_e_s3.next .def_342)))
(let ((.def_353 (and .def_343 .def_352)))
(let ((.def_339 (= call_synapse.ite_keyword16.next call_synapse.ite_keyword15.next)))
(let ((.def_341 (or .def_339 .def_340)))
(let ((.def_354 (and .def_341 .def_353)))
(let ((.def_337 (= call_synapse.dirty_s call_synapse.ite_keyword16.next)))
(let ((.def_338 (or param_e_s3.next .def_337)))
(let ((.def_355 (and .def_338 .def_354)))
(let ((.def_392 (and .def_355 .def_391)))
(let ((.def_332 (= call_synapse.valid_s call_synapse.ite_keyword7.next)))
(let ((.def_333 (or call_synapse.garde_s1.next .def_332)))
(let ((.def_328 (* (- 1) call_synapse.ite_keyword7.next)))
(let ((.def_329 (+ call_synapse.valid_s .def_328)))
(let ((.def_330 (= .def_329 (- 1))))
(let ((.def_331 (or .def_312 .def_330)))
(let ((.def_334 (and .def_331 .def_333)))
(let ((.def_325 (= call_synapse.valid_s call_synapse.ite_keyword8.next)))
(let ((.def_326 (or call_synapse.garde_s2.next .def_325)))
(let ((.def_335 (and .def_326 .def_334)))
(let ((.def_323 (= call_synapse.valid_s call_synapse.ite_keyword9.next)))
(let ((.def_324 (or call_synapse.garde_s3.next .def_323)))
(let ((.def_336 (and .def_324 .def_335)))
(let ((.def_393 (and .def_336 .def_392)))
(let ((.def_319 (= call_synapse.dirty_s call_synapse.ite_keyword14.next)))
(let ((.def_320 (or call_synapse.garde_s2.next .def_319)))
(let ((.def_317 (= call_synapse.dirty_s call_synapse.ite_keyword13.next)))
(let ((.def_318 (or call_synapse.garde_s1.next .def_317)))
(let ((.def_321 (and .def_318 .def_320)))
(let ((.def_315 (= call_synapse.dirty_s call_synapse.ite_keyword15.next)))
(let ((.def_316 (or call_synapse.garde_s3.next .def_315)))
(let ((.def_322 (and .def_316 .def_321)))
(let ((.def_394 (and .def_322 .def_393)))
(let ((.def_311 (= call_synapse.ite_keyword13.next 0)))
(let ((.def_313 (or .def_311 .def_312)))
(let ((.def_287 (<= 1 call_synapse.invalid_s)))
(let ((.def_310 (= .def_287 call_synapse.garde_s1.next)))
(let ((.def_314 (and .def_310 .def_313)))
(let ((.def_395 (and .def_314 .def_394)))
(let ((.def_305 (= call_synapse.ite_keyword14.next 1)))
(let ((.def_306 (or .def_303 .def_305)))
(let ((.def_302 (= call_synapse.ite_keyword8.next 0)))
(let ((.def_304 (or .def_302 .def_303)))
(let ((.def_307 (and .def_304 .def_306)))
(let ((.def_299 (<= 1 call_synapse.valid_s)))
(let ((.def_301 (= .def_299 call_synapse.garde_s2.next)))
(let ((.def_308 (and .def_301 .def_307)))
(let ((.def_396 (and .def_308 .def_395)))
(let ((.def_295 (= call_synapse.ite_keyword15.next 1)))
(let ((.def_296 (or .def_292 .def_295)))
(let ((.def_291 (= call_synapse.ite_keyword9.next 0)))
(let ((.def_293 (or .def_291 .def_292)))
(let ((.def_297 (and .def_293 .def_296)))
(let ((.def_289 (= .def_287 call_synapse.garde_s3.next)))
(let ((.def_298 (and .def_289 .def_297)))
(let ((.def_397 (and .def_298 .def_396)))
(let ((.def_286 (= call_synapse.mem_init_s call_synapse.flby.next)))
(let ((.def_398 (and .def_286 .def_397)))
(let ((.def_285 (= call_synapse.flby2.next call_synapse.ite_keyword6.next)))
(let ((.def_399 (and .def_285 .def_398)))
(let ((.def_284 (= call_synapse.flby3.next call_synapse.ite_keyword12.next)))
(let ((.def_400 (and .def_284 .def_399)))
(let ((.def_283 (= call_synapse.flby4.next call_synapse.ite_keyword18.next)))
(let ((.def_401 (and .def_283 .def_400)))
(let ((.def_279 (<= 0 param_init_invalid_s.next)))
(let ((.def_280 (and call_excludes3.excludes.next .def_279)))
(let ((.def_281 (and call_Sofar.Sofar .def_280)))
(let ((.def_282 (= call_Sofar.flby.next .def_281)))
(let ((.def_402 (and .def_282 .def_401)))
(let ((.def_260 (not env.next)))
(let ((.def_257 (<= 1 dirty_s.next)))
(let ((.def_258 (not .def_257)))
(let ((.def_255 (<= 2 invalid_s.next)))
(let ((.def_256 (not .def_255)))
(let ((.def_259 (or .def_256 .def_258)))
(let ((.def_261 (or .def_259 .def_260)))
(let ((.def_263 (= .def_261 _OK_.next)))
(let ((.def_254 (= call_synapse.invalid_s.next invalid_s.next)))
(let ((.def_264 (and .def_254 .def_263)))
(let ((.def_252 (= call_synapse.valid_s.next valid_s.next)))
(let ((.def_265 (and .def_252 .def_264)))
(let ((.def_250 (= call_synapse.dirty_s.next dirty_s.next)))
(let ((.def_266 (and .def_250 .def_265)))
(let ((.def_248 (= call_synapse.mem_init_s.next mem_init_s.next)))
(let ((.def_267 (and .def_248 .def_266)))
(let ((.def_246 (= call_Sofar.Sofar.next env.next)))
(let ((.def_268 (and .def_246 .def_267)))
(let ((.def_238 (= call_synapse.ite_keyword5.next call_synapse.ite_keyword6.next)))
(let ((.def_239 (or param_e_s1.next .def_238)))
(let ((.def_236 (= call_synapse.ite_keyword.next call_synapse.ite_keyword6.next)))
(let ((.def_226 (not param_e_s1.next)))
(let ((.def_237 (or .def_226 .def_236)))
(let ((.def_240 (and .def_237 .def_239)))
(let ((.def_232 (= call_synapse.ite_keyword12.next call_synapse.ite_keyword7.next)))
(let ((.def_233 (or .def_226 .def_232)))
(let ((.def_241 (and .def_233 .def_240)))
(let ((.def_229 (= call_synapse.ite_keyword11.next call_synapse.ite_keyword12.next)))
(let ((.def_230 (or param_e_s1.next .def_229)))
(let ((.def_242 (and .def_230 .def_241)))
(let ((.def_225 (= call_synapse.ite_keyword18.next call_synapse.ite_keyword13.next)))
(let ((.def_227 (or .def_225 .def_226)))
(let ((.def_243 (and .def_227 .def_242)))
(let ((.def_222 (= call_synapse.ite_keyword17.next call_synapse.ite_keyword18.next)))
(let ((.def_223 (or param_e_s1.next .def_222)))
(let ((.def_244 (and .def_223 .def_243)))
(let ((.def_269 (and .def_244 .def_268)))
(let ((.def_214 (= call_synapse.ite_keyword5.next call_synapse.ite_keyword4.next)))
(let ((.def_215 (or param_e_s2.next .def_214)))
(let ((.def_211 (= call_synapse.ite_keyword2.next call_synapse.ite_keyword5.next)))
(let ((.def_200 (not param_e_s2.next)))
(let ((.def_212 (or .def_200 .def_211)))
(let ((.def_216 (and .def_212 .def_215)))
(let ((.def_207 (= call_synapse.ite_keyword11.next call_synapse.ite_keyword8.next)))
(let ((.def_208 (or .def_200 .def_207)))
(let ((.def_217 (and .def_208 .def_216)))
(let ((.def_204 (= call_synapse.ite_keyword10.next call_synapse.ite_keyword11.next)))
(let ((.def_205 (or param_e_s2.next .def_204)))
(let ((.def_218 (and .def_205 .def_217)))
(let ((.def_199 (= call_synapse.ite_keyword17.next call_synapse.ite_keyword14.next)))
(let ((.def_201 (or .def_199 .def_200)))
(let ((.def_219 (and .def_201 .def_218)))
(let ((.def_196 (= call_synapse.ite_keyword16.next call_synapse.ite_keyword17.next)))
(let ((.def_197 (or param_e_s2.next .def_196)))
(let ((.def_220 (and .def_197 .def_219)))
(let ((.def_270 (and .def_220 .def_269)))
(let ((.def_193 (= call_synapse.flby2.next call_synapse.invalid_s.next)))
(let ((.def_271 (and .def_193 .def_270)))
(let ((.def_190 (= call_synapse.flby3.next call_synapse.valid_s.next)))
(let ((.def_272 (and .def_190 .def_271)))
(let ((.def_187 (= call_synapse.flby4.next call_synapse.dirty_s.next)))
(let ((.def_273 (and .def_187 .def_272)))
(let ((.def_184 (= call_synapse.flby.next call_synapse.mem_init_s.next)))
(let ((.def_274 (and .def_184 .def_273)))
(let ((.def_176 (and param_e_s2.next param_e_s1.next)))
(let ((.def_175 (and param_e_s3.next param_e_s1.next)))
(let ((.def_177 (or .def_175 .def_176)))
(let ((.def_173 (and param_e_s3.next param_e_s2.next)))
(let ((.def_178 (or .def_173 .def_177)))
(let ((.def_179 (not .def_178)))
(let ((.def_181 (= .def_179 call_excludes3.excludes.next)))
(let ((.def_275 (and .def_181 .def_274)))
(let ((.def_170 (= call_Sofar.flby.next call_Sofar.Sofar.next)))
