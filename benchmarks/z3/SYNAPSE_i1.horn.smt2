...
(let ((.def_130 (= call_synapse.ite9 0)))
...
(let ((.def_385 (= call_synapse.invalid_s call_synapse.ite.next)))
(let ((.def_386 (or call_synapse.garde_s1.next .def_385)))
(let ((.def_378 (* (- 1) call_synapse.ite.next)))
...
(let ((.def_369 (* (- 1) call_synapse.ite2.next)))
...
(let ((.def_367 (= call_synapse.invalid_s call_synapse.ite2.next)))
(let ((.def_368 (or call_synapse.garde_s2.next .def_367)))
(let ((.def_389 (and .def_368 .def_388)))
(let ((.def_358 (* (- 1) call_synapse.ite3.next)))
...
(let ((.def_305 (= call_synapse.ite14.next 1)))
(let ((.def_306 (or .def_303 .def_305)))
(let ((.def_302 (= call_synapse.ite8.next 0)))
...
(let ((.def_295 (= call_synapse.ite15.next 1)))
(let ((.def_296 (or .def_292 .def_295)))
(let ((.def_291 (= call_synapse.ite9.next 0)))
...
(let ((.def_285 (= call_synapse.flby2.next call_synapse.ite6.next)))
(let ((.def_399 (and .def_285 .def_398)))
(let ((.def_284 (= call_synapse.flby3.next call_synapse.ite12.next)))
(let ((.def_400 (and .def_284 .def_399)))
(let ((.def_283 (= call_synapse.flby4.next call_synapse.ite18.next)))
