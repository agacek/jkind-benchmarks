...
(let ((.def_250 (= call_voiture.speed call_voiture.ite_keyword2.next)))
(let ((.def_244 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_252 (or .def_244 .def_250)))
...
(let ((.def_256 (and .def_230 .def_255)))
...
(let ((.def_258 (and .def_226 .def_257)))
...
(let ((.def_263 (and .def_212 .def_262)))
.def_263)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
