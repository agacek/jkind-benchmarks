...
(let ((.def_410 (= call_synapse.invalid_s call_synapse.ite_keyword.next)))
(let ((.def_411 (or call_synapse.garde_s1.next .def_410)))
(let ((.def_403 (* (- 1) call_synapse.ite_keyword.next)))
...
(let ((.def_397 (+ .def_396 call_synapse.ite_keyword2.next)))
