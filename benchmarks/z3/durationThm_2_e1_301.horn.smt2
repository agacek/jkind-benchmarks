...
(let ((.def_142 (= call_Age.ite.next 0)))
(let ((.def_143 (or param_p .def_142)))
(let ((.def_138 (* (- 1) call_Age.ite.next)))
...
(let ((.def_133 (* (- 1) call_Age3.ite.next)))
