...
(let ((.def_255 (= call_voiture.dist call_voiture.ite_keyword.next)))
(let ((.def_243 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_256 (or .def_243 .def_255)))
(let ((.def_251 (* (- 1) call_voiture.ite_keyword.next)))
...
(let ((.def_246 (= call_voiture.speed call_voiture.ite_keyword2.next)))
(let ((.def_247 (or .def_243 .def_246)))
(let ((.def_240 (* (- 1) call_voiture.ite_keyword2.next)))
...
(let ((.def_237 (= call_voiture.time call_voiture.ite_keyword4.next)))
