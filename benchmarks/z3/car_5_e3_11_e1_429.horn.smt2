...
(let ((.def_263 (= call_voiture.speed call_voiture.ite2.next)))
(let ((.def_253 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_264 (or .def_253 .def_263)))
(let ((.def_259 (* (- 1) call_voiture.ite2.next)))
(let ((.def_260 (+ call_voiture.speed .def_259)))
(let ((.def_261 (= .def_260 1)))
(let ((.def_254 (not .def_253)))
(let ((.def_262 (or .def_254 .def_261)))
(let ((.def_265 (and .def_262 .def_264)))
(let ((.def_256 (= call_voiture.dist call_voiture.ite.next)))
...
(let ((.def_247 (= call_voiture.time call_voiture.ite4.next)))
(let ((.def_248 (or call_voiture.second.next .def_247)))
(let ((.def_241 (* (- 1) call_voiture.ite4.next)))
(let ((.def_242 (+ call_voiture.time .def_241)))
(let ((.def_245 (= .def_242 (- 2))))
...
(let ((.def_220 (and call_Sofar.Sofar call_excludes2.excludes.next)))
