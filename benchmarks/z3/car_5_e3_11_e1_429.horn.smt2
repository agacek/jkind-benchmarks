...
(let ((.def_263 (= call_voiture.speed call_voiture.ite_keyword2.next)))
(let ((.def_253 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_264 (or .def_253 .def_263)))
(let ((.def_259 (* (- 1) call_voiture.ite_keyword2.next)))
...
(let ((.def_256 (= call_voiture.dist call_voiture.ite_keyword.next)))
...
(let ((.def_247 (= call_voiture.time call_voiture.ite_keyword4.next)))
