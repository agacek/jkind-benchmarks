...
(let ((.def_72 (= call_speed.call_counter.ite call_speed.call_counter.pc)))
...
(let ((.def_59 (+ call_speed.call_counter.ite .def_58)))
(let ((.def_60 (= .def_59 0)))
(let ((.def_71 (or .def_60 .def_70)))
(let ((.def_74 (and .def_71 .def_73)))
(let ((.def_51 (= call_speed.ite (- 1))))
...
(let ((.def_24 (= call_speed.call_counter.ite2 call_speed.call_counter.c)))
...
(let ((.def_20 (= call_speed.call_counter.ite call_speed.call_counter.ite2)))
...
(let ((.def_181 (= call_speed.flby.next call_speed.ite3.next)))
(let ((.def_203 (and .def_181 .def_202)))
(let ((.def_179 (= call_speed.flby2.next call_speed.ite4.next)))
