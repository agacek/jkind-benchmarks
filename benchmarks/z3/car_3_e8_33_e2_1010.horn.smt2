...
(let ((.def_252 (= call_voiture.speed call_voiture.ite2.next)))
(let ((.def_246 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_254 (or .def_246 .def_252)))
(let ((.def_247 (not .def_246)))
(let ((.def_253 (or .def_247 .def_252)))
...
(let ((.def_257 (and .def_242 .def_256)))
...
(let ((.def_263 (and .def_218 .def_262)))
