...
(let ((.def_122 (not call_sustain.ite)))
(let ((.def_60 (not stop)))
...
(let ((.def_90 (or param_MaySafelyMove param_TryToMove1)))
...
(let ((.def_77 (= call_sustain.ite2 call_sustain.ite)))
(let ((.def_78 (or .def_72 .def_77)))
(let ((.def_73 (not .def_72)))
(let ((.def_75 (or .def_73 call_sustain.ite2)))
...
(let ((.def_264 (= call_sustain.s call_sustain.ite.next)))
(let ((.def_265 (or stop.next .def_264)))
(let ((.def_262 (not call_sustain.ite.next)))
...
(let ((.def_259 (= ite2.next flby3.next)))
(let ((.def_269 (and .def_259 .def_268)))
(let ((.def_258 (= call_sustain.flby.next call_sustain.ite2.next)))
...
(let ((.def_216 (or param_MaySafelyMove.next param_TryToMove1.next)))
...
(let ((.def_203 (= call_sustain.ite2.next call_sustain.ite.next)))
(let ((.def_198 (or start2.next start1.next)))
(let ((.def_204 (or .def_198 .def_203)))
(let ((.def_199 (not .def_198)))
(let ((.def_201 (or .def_199 call_sustain.ite2.next)))
...
(let ((.def_195 (and ite.next .def_194)))
(let ((.def_196 (= ite2.next .def_195)))
...
(let ((.def_172 (or moving.next ite.next)))
(let ((.def_170 (= param_MaySafelyMove.next ite.next)))
...
(let ((.def_164 (or .def_162 ite2.next)))
