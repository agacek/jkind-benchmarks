...
(let ((.def_477 (* (- 1) call__main_.call_hypothese2.ite3.next)))
...
(let ((.def_475 (= call__main_.call_hypothese2.ite2.next .def_470)))
...
(let ((.def_412 (or call__main_.avance0 call__main_.avance0.next)))
...
(let ((.def_404 (or call__main_.avance1 call__main_.avance1.next)))
