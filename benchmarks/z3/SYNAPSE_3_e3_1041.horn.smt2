...
(let ((.def_409 (= call_synapse.invalid_s call_synapse.ite.next)))
(let ((.def_410 (or call_synapse.garde_s1.next .def_409)))
(let ((.def_404 (* (- 1) call_synapse.invalid_s)))
(let ((.def_405 (+ .def_404 call_synapse.ite.next)))
