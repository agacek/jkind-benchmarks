...
(let ((.def_408 (= call_synapse.invalid_s call_synapse.ite.next)))
(let ((.def_409 (or call_synapse.garde_s1.next .def_408)))
(let ((.def_401 (* (- 1) call_synapse.ite.next)))
(let ((.def_404 (+ call_synapse.invalid_s .def_401)))
(let ((.def_405 (+ call_synapse.dirty_s .def_404)))
...
(let ((.def_391 (* (- 1) call_synapse.ite2.next)))
(let ((.def_396 (+ call_synapse.invalid_s .def_391)))
(let ((.def_397 (+ call_synapse.valid_s .def_396)))
(let ((.def_398 (+ call_synapse.dirty_s .def_397)))
(let ((.def_399 (= .def_398 2)))
(let ((.def_326 (not call_synapse.garde_s2.next)))
(let ((.def_400 (or .def_326 .def_399)))
