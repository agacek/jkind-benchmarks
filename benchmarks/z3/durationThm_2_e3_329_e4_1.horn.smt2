...
(let ((.def_99 (= call_Age3.flby.next call_Age3.ite.next)))
...
(rule (=> .init (state |_OK_| |call_Age.age_of_p| |call_Age.flby| |call_Age.ite| |call_Age2.age_of_p| |call_Age2.flby| |call_Age2.ite| |call_Age3.age_of_p| |call_Age3.flby| |call_Age3.ite| |call_Sofar.Sofar| |call_Sofar.flby| |env| |flby| |k| |param_q| |param_t|)))
(rule (=> (and (state |_OK_| |call_Age.age_of_p| |call_Age.flby| |call_Age.ite| |call_Age2.age_of_p| |call_Age2.flby| |call_Age2.ite| |call_Age3.age_of_p| |call_Age3.flby| |call_Age3.ite| |call_Sofar.Sofar| |call_Sofar.flby| |env| |flby| |k| |param_q| |param_t|) .trans) (state |_OK_.next| |call_Age.age_of_p.next| |call_Age.flby.next| |call_Age.ite.next| |call_Age2.age_of_p.next| |call_Age2.flby.next| |call_Age2.ite.next| |call_Age3.age_of_p.next| |call_Age3.flby.next| |call_Age3.ite.next| |call_Sofar.Sofar.next| |call_Sofar.flby.next| |env.next| |flby.next| |k.next| |param_q.next| |param_t.next|)))
(query (and (state |_OK_| |call_Age.age_of_p| |call_Age.flby| |call_Age.ite| |call_Age2.age_of_p| |call_Age2.flby| |call_Age2.ite| |call_Age3.age_of_p| |call_Age3.flby| |call_Age3.ite| |call_Sofar.Sofar| |call_Sofar.flby| |env| |flby| |k| |param_q| |param_t|) (not .property)))
