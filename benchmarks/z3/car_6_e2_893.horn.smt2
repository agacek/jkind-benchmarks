...
(let ((.def_239 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_251 (or .def_239 .def_250)))
(let ((.def_246 (* (- 1) call_voiture.ite.next)))
(let ((.def_247 (+ call_voiture.dist .def_246)))
(let ((.def_248 (= .def_247 (- 1))))
(let ((.def_240 (not .def_239)))
(let ((.def_249 (or .def_240 .def_248)))
(let ((.def_252 (and .def_249 .def_251)))
(let ((.def_244 (not bump)))
(let ((.def_245 (= flby.next .def_244)))
(let ((.def_253 (and .def_245 .def_252)))
(let ((.def_238 (= call_voiture.speed call_voiture.ite2.next)))
(let ((.def_242 (or .def_238 .def_239)))
...
(let ((.def_256 (and .def_227 .def_255)))
(let ((.def_224 (= param_s.next call_voiture.flby2.next)))
(let ((.def_257 (and .def_224 .def_256)))
...
(let ((.def_262 (and .def_211 .def_261)))
...
(let ((.def_263 (and .def_209 .def_262)))
.def_263))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
