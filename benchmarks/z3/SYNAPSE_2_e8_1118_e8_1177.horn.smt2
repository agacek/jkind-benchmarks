...
(let ((.def_392 (= call_synapse.invalid_s call_synapse.ite4.next)))
(let ((.def_393 (or param_e_s3.next .def_392)))
(let ((.def_390 (= call_synapse.ite4.next call_synapse.ite3.next)))
(let ((.def_384 (not param_e_s3.next)))
(let ((.def_391 (or .def_384 .def_390)))
(let ((.def_394 (and .def_391 .def_393)))
(let ((.def_388 (= call_synapse.ite10.next call_synapse.ite9.next)))
(let ((.def_389 (or .def_384 .def_388)))
(let ((.def_395 (and .def_389 .def_394)))
(let ((.def_386 (= call_synapse.valid_s call_synapse.ite10.next)))
(let ((.def_387 (or param_e_s3.next .def_386)))
(let ((.def_396 (and .def_387 .def_395)))
(let ((.def_383 (= call_synapse.ite16.next call_synapse.ite15.next)))
(let ((.def_385 (or .def_383 .def_384)))
(let ((.def_397 (and .def_385 .def_396)))
(let ((.def_381 (= call_synapse.dirty_s call_synapse.ite16.next)))
...
(let ((.def_359 (= call_synapse.invalid_s call_synapse.ite.next)))
...
(let ((.def_169 (and param_e_s1.next param_e_s2.next)))
(let ((.def_170 (and param_e_s1.next .def_169)))
(let ((.def_172 (and .def_170 param_e_s3.next)))
(let ((.def_173 (and param_e_s2.next .def_172)))
(let ((.def_174 (and param_e_s3.next .def_173)))
