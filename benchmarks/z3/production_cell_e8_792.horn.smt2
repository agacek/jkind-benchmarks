...
(let ((.def_121 (not call_sustain.Aite_keyword)))
(let ((.def_60 (not stop)))
...
(let ((.def_76 (= call_sustain.Aite_keyword2 call_sustain.Aite_keyword)))
(let ((.def_77 (or .def_65 .def_76)))
(let ((.def_72 (not .def_65)))
(let ((.def_74 (or .def_72 call_sustain.Aite_keyword2)))
...
(let ((.def_262 (= call_sustain.s call_sustain.Aite_keyword.next)))
(let ((.def_263 (or stop.next .def_262)))
(let ((.def_260 (not call_sustain.Aite_keyword.next)))
...
(let ((.def_257 (= Aite_keyword2.next flby3.next)))
(let ((.def_267 (and .def_257 .def_266)))
(let ((.def_256 (= call_sustain.flby.next call_sustain.Aite_keyword2.next)))
...
(let ((.def_201 (= call_sustain.Aite_keyword2.next call_sustain.Aite_keyword.next)))
(let ((.def_190 (and start2.next start1.next)))
(let ((.def_202 (or .def_190 .def_201)))
(let ((.def_197 (not .def_190)))
(let ((.def_199 (or .def_197 call_sustain.Aite_keyword2.next)))
...
(let ((.def_194 (and Aite_keyword.next .def_193)))
(let ((.def_195 (= Aite_keyword2.next .def_194)))
...
(let ((.def_171 (or moving.next Aite_keyword.next)))
(let ((.def_169 (= param_MaySafelyMove.next Aite_keyword.next)))
...
(let ((.def_163 (or .def_161 Aite_keyword2.next)))
