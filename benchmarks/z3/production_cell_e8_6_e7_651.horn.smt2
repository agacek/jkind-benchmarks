...
(declare-var |call_sustain.ite| Bool)
(declare-var |call_sustain.ite.next| Bool)
(declare-var |call_sustain.ite2| Bool)
(declare-var |call_sustain.ite2.next| Bool)
...
(let ((.def_121 (not call_sustain.ite)))
(let ((.def_60 (not stop)))
...
(let ((.def_76 (= call_sustain.ite2 call_sustain.ite)))
(let ((.def_77 (or .def_65 .def_76)))
(let ((.def_72 (not .def_65)))
(let ((.def_74 (or .def_72 call_sustain.ite2)))
...
(let ((.def_69 (and ite .def_68)))
(let ((.def_70 (= ite2 .def_69)))
...
(let ((.def_46 (or moving ite)))
(let ((.def_44 (= param_MaySafelyMove ite)))
...
(let ((.def_262 (= call_sustain.s call_sustain.ite.next)))
(let ((.def_263 (or stop.next .def_262)))
(let ((.def_260 (not call_sustain.ite.next)))
...
(let ((.def_257 (= ite2.next flby3.next)))
(let ((.def_267 (and .def_257 .def_266)))
(let ((.def_256 (= call_sustain.flby.next call_sustain.ite2.next)))
...
(let ((.def_201 (= call_sustain.ite2.next call_sustain.ite.next)))
(let ((.def_190 (and start2.next start1.next)))
(let ((.def_202 (or .def_190 .def_201)))
(let ((.def_197 (not .def_190)))
(let ((.def_199 (or .def_197 call_sustain.ite2.next)))
...
(let ((.def_194 (and ite.next .def_193)))
(let ((.def_195 (= ite2.next .def_194)))
...
(let ((.def_171 (or moving.next ite.next)))
(let ((.def_169 (= param_MaySafelyMove.next ite.next)))
...
(let ((.def_163 (or .def_161 ite2.next)))
...
(rule (=> .init (state |MayMove1| |MayMove2| |_OK_| |call_fedge.call_redge.flby| |call_fedge.call_redge.r| |call_fedge.f| |call_fedge2.call_redge.flby| |call_fedge2.call_redge.r| |call_fedge2.f| |call_redge.flby| |call_redge.r| |call_redge2.flby| |call_redge2.r| |call_redge3.flby| |call_redge3.r| |call_redge4.flby| |call_redge4.r| |call_sustain.flby| |call_sustain.ite| |call_sustain.ite2| |call_sustain.s| |flby| |flby2| |flby3| |ite| |ite2| |moving| |param_MaySafelyMove| |param_TryToMove1| |param_TryToMove2| |start1| |start2| |stop|)))
(rule (=> (and (state |MayMove1| |MayMove2| |_OK_| |call_fedge.call_redge.flby| |call_fedge.call_redge.r| |call_fedge.f| |call_fedge2.call_redge.flby| |call_fedge2.call_redge.r| |call_fedge2.f| |call_redge.flby| |call_redge.r| |call_redge2.flby| |call_redge2.r| |call_redge3.flby| |call_redge3.r| |call_redge4.flby| |call_redge4.r| |call_sustain.flby| |call_sustain.ite| |call_sustain.ite2| |call_sustain.s| |flby| |flby2| |flby3| |ite| |ite2| |moving| |param_MaySafelyMove| |param_TryToMove1| |param_TryToMove2| |start1| |start2| |stop|) .trans) (state |MayMove1.next| |MayMove2.next| |_OK_.next| |call_fedge.call_redge.flby.next| |call_fedge.call_redge.r.next| |call_fedge.f.next| |call_fedge2.call_redge.flby.next| |call_fedge2.call_redge.r.next| |call_fedge2.f.next| |call_redge.flby.next| |call_redge.r.next| |call_redge2.flby.next| |call_redge2.r.next| |call_redge3.flby.next| |call_redge3.r.next| |call_redge4.flby.next| |call_redge4.r.next| |call_sustain.flby.next| |call_sustain.ite.next| |call_sustain.ite2.next| |call_sustain.s.next| |flby.next| |flby2.next| |flby3.next| |ite.next| |ite2.next| |moving.next| |param_MaySafelyMove.next| |param_TryToMove1.next| |param_TryToMove2.next| |start1.next| |start2.next| |stop.next|)))
(query (and (state |MayMove1| |MayMove2| |_OK_| |call_fedge.call_redge.flby| |call_fedge.call_redge.r| |call_fedge.f| |call_fedge2.call_redge.flby| |call_fedge2.call_redge.r| |call_fedge2.f| |call_redge.flby| |call_redge.r| |call_redge2.flby| |call_redge2.r| |call_redge3.flby| |call_redge3.r| |call_redge4.flby| |call_redge4.r| |call_sustain.flby| |call_sustain.ite| |call_sustain.ite2| |call_sustain.s| |flby| |flby2| |flby3| |ite| |ite2| |moving| |param_MaySafelyMove| |param_TryToMove1| |param_TryToMove2| |start1| |start2| |stop|) (not .property)))
