...
(let ((.def_251 (= call_voiture.dist call_voiture.ite_keyword.next)))
(let ((.def_252 (or .def_248 .def_251)))
(let ((.def_245 (* (- 1) call_voiture.ite_keyword.next)))
...
(let ((.def_239 (= call_voiture.time call_voiture.ite_keyword4.next)))
