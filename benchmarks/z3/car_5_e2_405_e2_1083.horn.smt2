...
(let ((.def_248 (and call_voiture.meter.next call_voiture.move.next)))
(let ((.def_256 (or .def_248 .def_254)))
(let ((.def_249 (not .def_248)))
(let ((.def_255 (or .def_249 .def_254)))
(let ((.def_257 (and .def_255 .def_256)))
(let ((.def_251 (= call_voiture.dist call_voiture.ite.next)))
(let ((.def_252 (or .def_248 .def_251)))
(let ((.def_245 (* (- 1) call_voiture.ite.next)))
(let ((.def_246 (+ call_voiture.dist .def_245)))
(let ((.def_247 (= .def_246 (- 1))))
(let ((.def_250 (or .def_247 .def_249)))
(let ((.def_253 (and .def_250 .def_252)))
(let ((.def_258 (and .def_253 .def_257)))
(let ((.def_239 (= call_voiture.time call_voiture.ite4.next)))
(let ((.def_241 (or call_voiture.second.next .def_239)))
...
(let ((.def_263 (and .def_226 .def_262)))
...
(let ((.def_265 (and .def_223 .def_264)))
