...
(let ((.def_279 (= call_voiture.speed call_voiture.ite2.next)))
...
(let ((.def_285 (and .def_251 .def_284)))
...
(let ((.def_288 (and .def_241 .def_287)))
(let ((.def_240 (= call_voiture.flby6.next call_voiture.ite4.next)))
(let ((.def_289 (and .def_240 .def_288)))
...
(let ((.def_290 (and .def_238 .def_289)))
...
(let ((.def_291 (and .def_233 .def_290)))
.def_291)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
