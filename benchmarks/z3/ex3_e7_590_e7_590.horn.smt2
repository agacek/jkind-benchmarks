...
(let ((.def_67 (= call_speed.call__COUNTER_.ite call_speed.call__COUNTER_._PC_)))
...
(let ((.def_26 (= call_speed.call__COUNTER_.ite2 call_speed.call__COUNTER_._C_)))
...
(let ((.def_22 (= call_speed.call__COUNTER_.ite call_speed.call__COUNTER_.ite2)))
...
(let ((.def_167 (= call_speed.flby.next call_speed.ite3.next)))
(let ((.def_194 (and .def_167 .def_193)))
(let ((.def_165 (= call_speed.flby2.next call_speed.ite4.next)))
