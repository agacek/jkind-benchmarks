...
(let ((.def_466 (= call__main_.call_hypothese2.c call__main_.call_hypothese2.ite_keyword3.next)))
(let ((.def_464 (not param__B1_.next)))
(let ((.def_471 (or .def_464 .def_466)))
(let ((.def_469 (= call__main_.call_hypothese2.ite_keyword2.next .def_464)))
