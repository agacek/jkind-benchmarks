...
(let ((.def_393 (= call_synapse.invalid_s call_synapse.ite_keyword4.next)))
(let ((.def_394 (or param_e_s3.next .def_393)))
(let ((.def_391 (= call_synapse.ite_keyword4.next call_synapse.ite_keyword3.next)))
(let ((.def_385 (not param_e_s3.next)))
(let ((.def_392 (or .def_385 .def_391)))
(let ((.def_395 (and .def_392 .def_394)))
(let ((.def_389 (= call_synapse.ite_keyword10.next call_synapse.ite_keyword9.next)))
(let ((.def_390 (or .def_385 .def_389)))
(let ((.def_396 (and .def_390 .def_395)))
(let ((.def_387 (= call_synapse.valid_s call_synapse.ite_keyword10.next)))
(let ((.def_388 (or param_e_s3.next .def_387)))
(let ((.def_397 (and .def_388 .def_396)))
(let ((.def_384 (= call_synapse.ite_keyword16.next call_synapse.ite_keyword15.next)))
(let ((.def_386 (or .def_384 .def_385)))
(let ((.def_398 (and .def_386 .def_397)))
(let ((.def_382 (= call_synapse.dirty_s call_synapse.ite_keyword16.next)))
...
(let ((.def_360 (= call_synapse.invalid_s call_synapse.ite_keyword.next)))
(let ((.def_361 (or call_synapse.garde_s1.next .def_360)))
(let ((.def_353 (* (- 1) call_synapse.ite_keyword.next)))
