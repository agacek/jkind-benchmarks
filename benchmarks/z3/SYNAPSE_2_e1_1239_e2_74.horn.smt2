...
(let ((.def_353 (* (- 1) call_synapse.ite.next)))
(let ((.def_356 (+ call_synapse.invalid_s .def_353)))
...
(let ((.def_348 (+ call_synapse.invalid_s .def_343)))
(let ((.def_349 (+ call_synapse.valid_s .def_348)))
(let ((.def_350 (+ call_synapse.dirty_s .def_349)))
